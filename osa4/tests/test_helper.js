...
const dummyBlog = {title: 'TEST', author: 'TEST', url: 'https://test.com/', likes: 0, user: '5f049c89e106ab568c056b31' }
const emptyLikes = {title: 'TEST', author: 'TEST', url: 'https://test.com/', user: '5f049c89e106ab568c056b31' }
const emptyTitle = {author: 'TEST', url: 'https://test.com/', likes: 0, user: '5f049c89e106ab568c056b31' }
const emptyURL = {title: 'TEST', author: 'TEST', likes: 0, user: '5f049c89e106ab568c056b31' }
...
const dummyUser = {username: 'TEST', name: 'test', password: 'validpassword'}
...
module.exports = {
  ...
  emptyPassword, dummyUser, invalidPassword, usernameUsed, users,
  usersInDb, blogsInDb
