...
const empty = []
const oneBlog = [{ _id: '5a422a851b54a676234d17f7', title: 'React patterns', author: 'Michael Chan', url: 'https://reactpatterns.com/', likes: 7, __v: 0 }]
const multipleBlogs = [
...
describe('most productive author',() => {
  test('is one with most blogs', () => {
    const result = listHelper.mostBlogs(multipleBlogs)
    expect(result).toEqual({ author: 'Robert C. Martin', blogs: 3 })
  })
})
describe('most liked author',() => {
  test('and his/hers total likes are calculated right', () => {
